...
///////// Gloss:
                ...
                float gloss = _MetallicTex_var.g;
                float perceptualRoughness = 1.0 - _MetallicTex_var.g;
...
////// Specular:
                float3 specularColor = _MetallicTex_var.r;
...
/// Final Color:
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : SV_Target {
                ...
                float3 specColor;
                float4 _MetallicTex_var = tex2D(_MetallicTex,TRANSFORM_TEX(i.uv0, _MetallicTex));
                diffColor = DiffuseAndSpecularFromMetallic( diffColor, _MetallicTex_var.r, specColor, specularMonochrome );
                float roughness = 1.0 - _MetallicTex_var.g;
